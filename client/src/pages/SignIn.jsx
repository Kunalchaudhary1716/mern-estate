  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4' >
        ...
        <button disabled={loading} className='bg-slate-700 text-white p-3 rounded-lg uppercase hover:scale-90'>{loading ? 'loading...' : 'Sign In'}</button>
      </form>
      ...
      {error && <p className='text-red-500 mt-5'>{}wrong credentials</p>}
    </div>
  )
}
